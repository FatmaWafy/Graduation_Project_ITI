...
export default function ExamDashboard() {
  ...
  if (!exam) return <div className="flex justify-center items-center h-screen">Exam not found</div>

  const currentQuestion = questions[currentQuestionIndex] || null

  if (!currentQuestion) return <div className="flex justify-center items-center h-screen">No questions available</div>
