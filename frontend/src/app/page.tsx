...
export default function Home() {
  ...
  const sendNotes = async () => {
    if (!message || !selectedStudent) return setError("Please select a student and enter a message");
  ...
  >
    ...
    {Array.isArray(students) && students.length > 0 ? (
      ...
      <option disabled>لا يوجد طلاب متاحون</option>
    )}
  </select>
  ...
  >
    ...
    {Array.isArray(predefinedNotifications) && predefinedNotifications.length > 0 ? (
      ...
      <option disabled>لا يوجد إشعارات متاحة</option>
    )}
  </select>
