...
export default function AddStudentPage() {
  const [studentData, setStudentData] = useState({
    ...
    leetcode_username: "",
    github_profile: "",
    track: "", // غيرنا من track_name إلى track عشان يبعت الـ id
  });
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (activeTab === "bulk") {
      ...
      try {
        const response = await fetch(
          "http://127.0.0.1:8000/users/register-students-excel/",
          {
            method: "POST",
            headers: {
      ...
      try {
        console.log("Submitting student data:", JSON.stringify(studentData)); // للتأكد من شكل البيانات
        const response = await fetch(
          "http://127.0.0.1:8000/users/register-student/",
          {
            method: "POST",
            headers: {
      ...
      <div className='container mx-auto px-4 py-8'>
        ...
        <div className='mb-8'>
          <div className='flex items-center justify-between'>
            <div>
              <h1 className='text-3xl font-bold text-[#007acc]'>
                Student Registration
              </h1>
              <p className='mt-2 text-[#007abc]'>
            ...
            <div className='hidden md:block'>
              <div className='flex items-center space-x-2 bg-white p-3 rounded-lg shadow-sm border border-[#c7e5ff]'>
                ...
                <span className='text-sm text-gray-600'>
                  Students are automatically notified via email
                </span>
              </div>
            </div>
          </div>
              ...
              <CardContent className='p-4'>
                <ul className='space-y-3 text-sm'>
                  <li className='flex items-start'>
                    ...
                    <span>
                      Use <strong>Single Student</strong> mode for adding
                      individual students
                    </span>
                  </li>
                  <li className='flex items-start'>
                    ...
                    <span>
                      Use <strong>Bulk Upload</strong> for adding multiple
                      students at once
                    </span>
                  </li>
                  <li className='flex items-start'>
                    ...
                    <span>
                      Students will receive login credentials via email
                    </span>
                  </li>
                </ul>
              </CardContent>
              ...
              >
                <div className='bg-[#007acc] text-white p-4'>
                  ...
                  <TabsList className='grid w-full grid-cols-2 bg-[#0069b3]'>
                    <TabsTrigger
                      value='single'
                      className='flex items-center gap-2 data-[state=active]:bg-white text-white data-[state=active]:text-[#007acc]'
                    >
                  ...
                  <TabsContent value='single'>
                    <form onSubmit={handleSubmit} className='space-y-6'>
                      <div className='bg-[#f8fcff] border border-[#c7e5ff] rounded-lg p-5'>
                        ...
                        <div className='grid grid-cols-1 md:grid-cols-2 gap-5'>
                          <div className='space-y-2'>
                            <Label
                              htmlFor='username'
                              className='flex items-center gap-2 text-[#007acc]'
                            >
                      ...
                      <div className='bg-[#f8fcff] border border-[#c7e5ff] rounded-lg p-5'>
                        <h3 className='text-[#007acc] font-medium mb-4 flex items-center'>
                          <svg
                            className='h-5 w-5 mr-2 text-[#007acc]'
                            fill='currentColor'
                            viewBox='0 0 20 20'
                          >
                            <path
                    ...
                    <div className='space-y-6'>
                      <div className='bg-[#f8fcff] border border-[#c7e5ff] rounded-lg p-5'>
                        ...
                        <div className='bg-white border border-gray-200 rounded-md p-4'>
                          ...
                          <p className='text-sm text-gray-600'>
                            Optional columns: university, graduation_year,
                            college, leetcode_profile, github_profile
                          </p>
                        </div>
                      </div>
                      ...
                      <form onSubmit={handleSubmit} className='space-y-5'>
                        <div className='bg-[#f8fcff] border border-[#c7e5ff] rounded-lg p-5'>
                          <Label
                            htmlFor='csv-upload'
                            className='flex items-center gap-2 text-[#007acc] mb-3'
                          >
                ...
                <CardFooter className='bg-[#c7e5ff] p-4 text-center text-sm text-[#007acc] border-t border-[#c7e5ff]'>
                  <div className='flex items-center justify-center w-full'>
                    <svg
                      className='h-4 w-4 mr-2 text-[#007acc]'
                      fill='currentColor'
                      viewBox='0 0 20 20'
                    >
                      <path
                    ...
                    All student information will be securely stored in our
                    database
                  </div>
                </CardFooter>
              </Tabs>
