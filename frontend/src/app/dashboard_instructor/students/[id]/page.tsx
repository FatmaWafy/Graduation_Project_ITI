...
export default function StudentDetailPage() {
  ...
  const trackName = tracks.find((t) => t.id === student.track)?.name || "Not assigned"

  const branchName = branches.find((b) => b.id === student.branch)?.name || "Not assigned"
    ...
    <div className="container mx-auto py-6 space-y-6">
      ...
      <div className="grid gap-6 md:grid-cols-3">
          ...
          <CardHeader className="pb-2">
            <div className="flex flex-col items-center text-center">
              <Avatar className="h-24 w-24 border-4 border-[#f0f9ff]">
                <AvatarImage
                  src={getImageUrl(student.user.profile_image) || "/placeholder.svg"}
                  alt={displayName}
                  onError={(e) => {
              ...
              <div className="mt-4">
                <CardTitle className="text-2xl text-[#007acc]">{displayName}</CardTitle>
                <CardDescription className="mt-1">Student ID: {student.id}</CardDescription>
            ...
            <div className="space-y-4">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">{student.user.username || "Not provided"}</p>
                </div>
              </div>
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">{student.user.email || "Not provided"}</p>
                </div>
              </div>
              <div className="flex items-start">
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">{student.university || "Not provided"}</p>
                </div>
              </div>
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">{student.graduation_year || "Not provided"}</p>
                </div>
              </div>
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">{student.user.phone_number || "Not provided"}</p>
                </div>
              </div>
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">{student.user.address || "Not provided"}</p>
                </div>
              </div>
              <div className="flex items-start">
                ...
                <div>
                  ...
                  {student.github_profile ? (
                    ...
                    >
                      {student.github_profile.replace("https://github.com/", "")}
                    </a>
                  ) : (
        ...
        <Card className="md:col-span-2 border-[#e6f4ff] bg-white shadow-sm">
          <CardHeader>
            <CardTitle className="text-xl text-[#007acc]">Student Information</CardTitle>
            <CardDescription>View detailed information and progress</CardDescription>
          </CardHeader>
          <CardContent>
