    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('instructor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='events', to='users.instructor')),
            ],
        ),
        migrations.CreateModel(
            name='Notification',
            fields=[
                ...
                ('instructor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='notifications', to='users.instructor')),
            ],
        ),
        migrations.CreateModel(
            name='Track',
