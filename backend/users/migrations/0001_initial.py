    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(default='instructor', max_length=10)),
                ('email', models.EmailField(max_length=254, unique=True)),
                ('groups', models.ManyToManyField(blank=True, related_name='instructor_groups', to='auth.group')),
                ('user_permissions', models.ManyToManyField(blank=True, related_name='instructor_permissions', to='auth.permission')),
            ],
            options={
